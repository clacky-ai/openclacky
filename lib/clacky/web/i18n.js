...
const I18n = (() => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      "newSession.deepLink.fromLink": "Prefilled from an external link — review it before sending.",
      "newSession.deepLink.long":     "Prefilled from an external link — {{count}} characters. Read the whole prompt before sending.",
      "newSession.deepLink.tooLong":  "The link's prompt was too long (over {{max}} characters), so it was not filled in.",
      ...
      "chat.input.cancelSteerMode": "Cancel guidance",
      "chat.input.cancelSteerDescription": "Return this message to the queue, keeping its position.",
      ...
      "chat.copy":           "Copy",
      "chat.search.verb":    "Searched",
      "chat.search.count":   "{{count}} results",
      "chat.search.showAll": "Show all {{count}} results ▾",
      "chat.search.showLess": "Show less ▴",
      ...
      "sessions.actions.selectMultiple": "Bulk Delete",
      "sessions.select.count": "{{n}} selected",
      "sessions.select.countOf": "{{n}} of {{total}} selected",
      "sessions.select.cancel": "Cancel",
      "sessions.select.delete": "Delete {{n}}",
      "sessions.select.confirmDelete": "Delete {{n}} selected sessions? This cannot be undone.",
      "sessions.select.deleteFailed": "Failed to delete {{n}} session(s)",
      ...
      "extensions.group.user":       "Personal",
      ...
      "share.action.download":    "Download receipt",
      "share.action.close":       "Close",
      "share.stage.loading":      "Tallying your usage…",
      ...
      "share.theme.label":        "Background",
      "share.theme.dusk":         "Dusk",
      "share.theme.sky":          "Sky",
      "share.theme.mint":         "Mint",
      "share.theme.sunset":       "Sunset",
      ...
      "billing.share.btn":              "Print receipt",
      "billing.share.tooltip":          "Print my AI usage receipt",
      ...
      "share.receipt.tagline":              "your AI workflow, on the record",
      "share.scorecard.receipt.title":      "DAILY AI RECEIPT",
      "share.scorecard.receipt.tagline":    "via {{brand}} · scorecard",
      "share.scorecard.receipt.date":       "DATE",
      "share.scorecard.receipt.issued":     "ISSUED",
      "share.scorecard.receipt.totalLabel": "TOTAL API SPEND",
      "share.scorecard.receipt.totalSub":   "safe usage · data cost",
      "share.scorecard.receipt.modelsHead": "CLIENT / MODEL",
      "share.scorecard.receipt.costHead":   "COST",
      "share.scorecard.receipt.tokensHead": "TOKEN COUNT",
      "share.scorecard.receipt.input":      "INPUT",
      "share.scorecard.receipt.output":     "OUTPUT",
      "share.scorecard.receipt.cache":      "CACHE HIT RATE",
      "share.scorecard.receipt.sessions":   "SESSIONS",
      "share.scorecard.receipt.brandLine":  "Use {{brand}} on Mac and Windows",
      "share.scorecard.receipt.sign":       "— generated by {{brand}} —",
      ...
      "sib.auto.tag":          "Economy",
      "sib.auto.tipTitle":     "Auto · economy-first routing",
      "sib.auto.tip":          "Starts with the cheapest model and upgrades only when necessary. Picks the most popular, capable and affordable models in real time. The price ratio floats accordingly.",
    ...
    zh: {
      ...
      "newSession.deepLink.fromLink": "内容来自外部链接，发送前请先确认。",
      "newSession.deepLink.long":     "内容来自外部链接，共 {{count}} 字符，发送前请滚动确认全部内容。",
      "newSession.deepLink.tooLong":  "链接中的内容过长（超过 {{max}} 字符），未填入输入框。",
      ...
      "chat.input.cancelSteerMode": "取消引导",
      "chat.input.cancelSteerDescription": "退回队列，保持原有顺序",
      ...
      "chat.copy":           "复制",
      "chat.search.verb":    "搜索",
      "chat.search.count":   "共 {{count}} 条结果",
      "chat.search.showAll": "显示全部 {{count}} 条 ▾",
      "chat.search.showLess": "收起 ▴",
      ...
      "sessions.actions.selectMultiple": "批量删除",
      "sessions.select.count": "已选 {{n}} 项",
      "sessions.select.countOf": "已选 {{n}} / 共 {{total}} 个会话",
      "sessions.select.cancel": "取消",
      "sessions.select.delete": "删除 {{n}} 项",
      "sessions.select.confirmDelete": "删除选中的 {{n}} 个会话？此操作不可撤销。",
      "sessions.select.deleteFailed": "{{n}} 个会话删除失败",
      ...
      "share.action.download":    "下载对账单",
      "share.action.close":       "关闭",
      "share.stage.loading":      "正在统计用量…",
      ...
      "share.theme.label":        "背景",
      "share.theme.dusk":         "暮光",
      "share.theme.sky":          "晴空",
      "share.theme.mint":         "薄荷",
      "share.theme.sunset":       "日落",
      ...
      // ── 成绩单分享（B 线：省钱 / 缓存命中炫耀）──
      "billing.share.btn":              "打印对账单",
      "billing.share.tooltip":          "打印我的 AI 对账单",
      "share.scorecard.modal.title":    "我的 {{brand}} 成绩单",
      "share.scorecard.modal.subtitle": "选个风格、改改文案 —— 数字已经帮你填好了。",
      "share.receipt.tagline":              "你的 AI 工作流，白纸黑字",
      "share.scorecard.receipt.title":      "每日 AI 对账单",
      "share.scorecard.receipt.tagline":    "via {{brand}} · scorecard",
      "share.scorecard.receipt.date":       "日期",
      "share.scorecard.receipt.issued":     "出账时间",
      "share.scorecard.receipt.totalLabel": "API 总费用",
      "share.scorecard.receipt.totalSub":   "API 安全消费 · 数据成本",
      "share.scorecard.receipt.modelsHead": "客户端 / 模型",
      "share.scorecard.receipt.costHead":   "费用",
      "share.scorecard.receipt.tokensHead": "计 Token 数",
      "share.scorecard.receipt.input":      "输入",
      "share.scorecard.receipt.output":     "输出",
      "share.scorecard.receipt.cache":      "缓存命中率",
      "share.scorecard.receipt.sessions":   "会话数",
      "share.scorecard.receipt.brandLine":  "在 Mac 和 Windows 上使用 {{brand}}",
      "share.scorecard.receipt.sign":       "—— 本单由 {{brand}} 生成 ——",
      ...
      "sib.auto.tag":          "经济优先",
      "sib.auto.tipTitle":     "Auto · 经济优先",
      "sib.auto.tip":          "从最便宜的开始，只在必要时升级模型。实时选用当下最流行、好用、便宜的模型。倍率随之浮动。",
