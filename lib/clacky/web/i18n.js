...
const I18n = (() => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      "changes.restore.failed":  "Revert failed",      "tm.tab":                   "History",
      ...
      "settings.models.placeholder.provider": "- Choose provider -",      "settings.models.placeholder.model":    "e.g. claude-sonnet-4-5",
      ...
      "onboard.device.success.note":        "During the trial only Gemini 3.7 Flash is available — top up any amount to unlock all frontier models on this same key.",
    ...
    zh: {
      ...
      "settings.models.placeholder.provider": "- 选择服务商 -",      "settings.models.placeholder.model":    "如 claude-sonnet-4-5",
      "settings.models.placeholder.baseurl":  "https://api.anthropic.com",
      "settings.models.placeholder.apikey":   "sk-…",
      ...
      "onboard.device.success.note":        "试用期内仅可使用 Gemini 3.7 Flash —— 任意金额充值后，同一 Key 立即解锁全部前沿模型。",
