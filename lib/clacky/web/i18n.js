...
const I18n = (() => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      "sib.auto.tip":          "Starts with the cheapest model and upgrades only when necessary. Picks the most popular, capable and affordable models in real time.",
    ...
    zh: {
      ...
      "sib.auto.tip":          "从最便宜的开始，只在必要时升级模型。实时选用当下最流行、好用、便宜的模型。",
