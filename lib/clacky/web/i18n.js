...
const I18n = (() => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      "trash.confirmEmptySessionOld": "Permanently delete all trashed sessions older than 7 days?\nThis cannot be undone.",
      "trash.confirmEmptySessionAll": "Permanently delete ALL trashed sessions?\nThis cannot be undone.",
    ...
    zh: {
      ...
      "trash.confirmEmptySessionOld": "永久删除 7 天前放入回收站的所有会话？\n此操作不可撤销。",
      "trash.confirmEmptySessionAll": "永久删除回收站中的所有会话？\n此操作不可撤销。",
