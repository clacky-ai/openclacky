...
const I18n = (() => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      "settings.homepage.title":  "Default homepage",
      "settings.homepage.desc":   "Choose what opens when you visit the home page or click the logo.",
      "settings.homepage.auto":   "Automatic (use the only extension candidate)",
      "settings.homepage.native": "OpenClacky native page",
      "settings.homepage.save":   "Save",
      "settings.homepage.restore":"Restore",
      "settings.homepage.saved":  "Default homepage saved.",
      "settings.homepage.restored":"Automatic homepage selection restored.",
      "settings.homepage.failed": "Failed to save the default homepage.",
    ...
    zh: {
      ...
      "settings.homepage.title":  "默认首页",
      "settings.homepage.desc":   "选择访问首页或点击 Logo 时打开的页面。",
      "settings.homepage.auto":   "自动（优先使用唯一扩展候选）",
      "settings.homepage.native": "OpenClacky 原生页面",
      "settings.homepage.save":   "保存",
      "settings.homepage.restore":"还原",
      "settings.homepage.saved":  "默认首页已保存。",
      "settings.homepage.restored":"已还原自动首页选择。",
      "settings.homepage.failed": "默认首页保存失败。",
