...
const I18n = (() => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      "settings.models.field.noVision":    "Model does not support image input (vision)",
    ...
    zh: {
      ...
      "projects.menu.pin": "置顶",
      "projects.menu.unpin": "取消置顶",
      ...
      "settings.models.field.noVision":    "模型不支持图片输入（vision）",
