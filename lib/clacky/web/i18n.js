...
const I18n = (() => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      "settings.models.group.all":        "All",
      "settings.models.group.field":      "Group",
      "settings.models.group.ungrouped":  "Ungrouped",
      "settings.models.group.add":        "+ Add Group",
      "settings.models.group.name":       "Group name",
      "settings.models.group.addBtn":     "Add",
      "settings.models.group.rename":     "Rename",
      "settings.models.group.delete":     "Delete",
      "settings.models.group.addModel":   "Select Models",
      "settings.models.group.addTo":      "Add models to \"{{name}}\"",
      "settings.models.group.selectAll":  "Select All",
      "settings.models.group.noCandidates": "No other models to add",
      "settings.models.group.added":      "Added {{n}} models to \"{{name}}\"",
      "settings.models.group.confirmDelete": "Delete group \"{{name}}\"? Models in it will be moved to Ungrouped.",
      "settings.models.group.empty":      "No models in this group",
      "settings.models.group.placeholder":"Select group…",
      "settings.models.group.duplicate":  "Group \"{{name}}\" already exists",
    ...
    zh: {
      ...
      "settings.models.group.all":        "全部",
      "settings.models.group.field":      "分组",
      "settings.models.group.ungrouped":  "未分组",
      "settings.models.group.add":        "+ 新建分组",
      "settings.models.group.name":       "分组名称",
      "settings.models.group.addBtn":     "添加",
      "settings.models.group.rename":     "重命名",
      "settings.models.group.delete":     "删除",
      "settings.models.group.addModel":   "选择已有模型",
      "settings.models.group.addTo":      "添加模型到「{{name}}」",
      "settings.models.group.selectAll":  "全选",
      "settings.models.group.noCandidates": "没有其他可添加的模型",
      "settings.models.group.added":      "已将 {{n}} 个模型添加到「{{name}}」",
      "settings.models.group.confirmDelete": "删除分组「{{name}}」？组内模型将移至「未分组」。",
      "settings.models.group.empty":      "该分组暂无模型",
      "settings.models.group.placeholder":"选择分组…",
      "settings.models.group.duplicate":  "分组「{{name}}」已存在",
