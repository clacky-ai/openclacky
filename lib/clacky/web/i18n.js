...
const I18n = (() => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      "settings.models.badge.image":   "Image",
      "settings.models.badge.video":   "Video",
      "settings.models.badge.audio":   "Audio",
      ...
      "settings.models.field.role":                 "Model role",
      "settings.models.role.none":                  "None (additional model)",
      "settings.models.role.default":               "Default chat model",
      "settings.models.role.lite":                  "Lite chat model",
      "settings.models.role.image":                 "Image generation",
      "settings.models.role.video":                 "Video generation",
      "settings.models.role.audio":                 "Audio (TTS)",
    ...
    zh: {
      ...
      "settings.models.badge.image":   "生图",
      "settings.models.badge.video":   "生视频",
      "settings.models.badge.audio":   "语音",
      ...
      "settings.models.field.role":                 "模型用途",
      "settings.models.role.none":                  "不指定（备用模型）",
      "settings.models.role.default":               "默认对话模型",
      "settings.models.role.lite":                  "轻量对话模型",
      "settings.models.role.image":                 "图片生成",
      "settings.models.role.video":                 "视频生成",
      "settings.models.role.audio":                 "语音合成 (TTS)",
