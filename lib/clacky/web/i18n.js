...
const I18n = (() => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      "settings.brand.skillsPrompt":       "Your brand skills are ready to download. ",
      "settings.brand.skillsBtn":          "Go to Brand Skills →",
    ...
    zh: {
      ...
      "settings.brand.skillsPrompt":       "品牌技能包已就绪，立即前往下载。",
      "settings.brand.skillsBtn":          "前往品牌技能包 →",
