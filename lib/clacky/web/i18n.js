...
const I18n = (() => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      "settings.tabs.voice":      "Voice Input",
      ...
      // ── Voice input ──
      "voice.btn.toggle":       "Voice input",
      "voice.btn.listening":    "Listening…",
      "voice.btn.pushToTalk":   "Push to talk — click to send",
      "voice.btn.voiceMode":    "Hands-free — auto-send",

      // ── Voice settings ──
      "settings.voice.title":             "Voice Input",
      "settings.voice.desc":              "Configure speech recognition engine for voice input.",
      "settings.voice.asrEngine":         "ASR Engine",
      "settings.voice.asrEngineTitle":     "ASR Engine",
      "settings.voice.languageTitle":     "Recognition Language",
      "settings.voice.engine.browser":    "Browser Native",
      "settings.voice.engine.dashscope":  "DashScope (Alibaba Cloud)",
      "settings.voice.browserSupported":  "✓ Current browser supports voice input",
      "settings.voice.browserUnsupported": "✗ Current browser doesn't support voice input. Use Chrome/Edge/Safari or configure DashScope engine.",
      "settings.voice.apiKey":            "API Key",
      "settings.voice.apiKeyHint":        "Get your key from DashScope console",
      "settings.voice.save":              "Save",
      "settings.voice.saving":            "Saving…",
      "settings.voice.saved":             "Saved ✓",
      "settings.voice.unsupported":       "Current browser doesn't support voice input. Use Chrome/Edge/Safari or configure DashScope engine in Settings.",
      "settings.voice.language":          "Recognition Language",
      "settings.voice.defaultMode":        "Default Mode",
      "settings.voice.mode.pushToTalk":   "Push to Talk",
      "settings.voice.mode.handsFree":    "Hands-free",
      "settings.voice.modeHint":         "Push to Talk: click the mic icon to record, then click send manually. Hands-free: continuous recognition with auto-send on silence.",
      "settings.voice.behavior":          "Behavior",
      "settings.voice.silenceTimeout":    "Silence timeout (ms)",
      "settings.voice.silenceTimeoutHint": "In Hands-free mode, auto-finalize and send the current utterance after this many ms of silence.",
      "settings.voice.restartDelay":      "Restart delay (ms)",
      "settings.voice.restartDelayHint":  "In Hands-free mode, wait this many ms before restarting recognition after silence. Too short may cause missed words; too long adds a noticeable pause between sentences. If recognition errors occur frequently, try increasing this value.",
      "settings.voice.shortcuts":         "Keyboard Shortcuts",
      "settings.voice.shortcut.toggle":   "Toggle Start/Stop",
      "settings.voice.shortcut.stop":     "Stop Voice",
      "settings.voice.shortcut.start":    "Start Voice",
      "settings.voice.shortcut.voiceMode": "Mode Toggle",
      "settings.voice.shortcut.hint":     "All shortcuts use Ctrl+Shift+key. Leave empty to disable.",
      "settings.voice.exitWords":         "Exit Words",
      "settings.voice.exitWordsPlaceholder": "stop listening, exit voice, goodbye",
      "settings.voice.exitWordsHint":     "Comma-separated spoken phrases (supports both , and ，). When recognized, voice input stops automatically.",
      "settings.voice.sound":             "Sound Effects",
      "settings.voice.soundVolume":       "Notification Volume",
    ...
    zh: {
      ...
      // ── 语音输入 ──
      "voice.btn.toggle":       "语音输入",
      "voice.btn.listening":    "录音中…",
      "voice.btn.pushToTalk":   "点击发送 — 逐条识别",
      "voice.btn.voiceMode":    "自动发送 — 连续对话",

      // ── 语音设置 ──
      "settings.voice.title":             "语音输入",
      "settings.voice.desc":              "配置语音识别引擎，用于语音输入。",
      "settings.voice.asrEngine":         "语音识别引擎",
      "settings.voice.asrEngineTitle":     "语音识别引擎",
      "settings.voice.languageTitle":     "识别语言",
      "settings.voice.engine.browser":    "浏览器原生",
      "settings.voice.engine.dashscope":  "DashScope（阿里云）",
      "settings.voice.browserSupported":  "✓ 当前浏览器支持语音输入",
      "settings.voice.browserUnsupported": "✗ 当前浏览器不支持语音输入，请使用 Chrome/Edge/Safari 或配置 DashScope 引擎。",
      "settings.voice.apiKey":            "API Key",
      "settings.voice.apiKeyHint":        "在 DashScope 控制台获取 API Key",
      "settings.voice.save":              "保存",
      "settings.voice.saving":            "保存中…",
      "settings.voice.saved":             "已保存 ✓",
      "settings.voice.unsupported":       "当前浏览器不支持语音输入，请使用 Chrome/Edge/Safari 或在设置中配置 DashScope 引擎。",
      "settings.voice.language":          "识别语言",
      "settings.voice.defaultMode":        "默认模式",
      "settings.voice.mode.pushToTalk":   "点击发送",
      "settings.voice.mode.handsFree":    "连续对话",
      "settings.voice.modeHint":         "点击发送：点击麦克风图标录音，再点击发送按钮手动发送。连续对话：持续识别，静音后自动发送。",
      "settings.voice.behavior":          "行为参数",
      "settings.voice.silenceTimeout":    "静音超时 (ms)",
      "settings.voice.silenceTimeoutHint": "连续对话模式下，静音超过此时长后自动结束当前语句并自动发送。",
      "settings.voice.restartDelay":      "重启延迟 (ms)",
      "settings.voice.restartDelayHint":  "连续对话模式下，静音结束后等待此时长再重新开始识别。过短可能导致句间停顿被误判为新语句，过长则语句间有明显延迟。如遇识别异常，可尝试增大此值。",
      "settings.voice.shortcuts":         "快捷键",
      "settings.voice.shortcut.toggle":   "切换开始/停止",
      "settings.voice.shortcut.stop":     "停止语音",
      "settings.voice.shortcut.start":    "开始语音",
      "settings.voice.shortcut.voiceMode": "模式切换",
      "settings.voice.shortcut.hint":     "所有快捷键使用 Ctrl+Shift+key。留空则禁用。",
      "settings.voice.exitWords":         "退出词",
      "settings.voice.exitWordsPlaceholder": "停止聆听，退出语音，再见",
      "settings.voice.exitWordsHint":     "逗号分隔的语音指令（支持中英文逗号），识别到该词后自动停止语音输入。",
      "settings.voice.sound":             "音效",
      "settings.voice.soundVolume":       "提示音音量",
