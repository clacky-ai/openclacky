...
const I18n = (() => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      "projects.menu.deleteSessions": "Delete Sessions",
      ...
      "projects.deleteSessions.confirm": "Delete all sessions in project \"{{name}}\"? The project itself will be kept.",
      ...
      "settings.models.field.apiProtocol":          "API Protocol",
      "settings.models.apiProtocol.auto":           "Auto (detect from provider)",
    ...
    zh: {
      ...
      "settings.models.field.apiProtocol":          "API 协议",
      "settings.models.apiProtocol.auto":           "自动（根据服务商检测）",
