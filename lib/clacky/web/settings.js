...
const Settings = (() => {
  ...
  async function _saveModalModel() {
    ...
    // Explicit protocol override (issue #466): empty string = auto (backend
    // resolves from provider preset / model overrides).
    const api_format = document.getElementById("model-modal-api-format").value.trim();
