...
const Settings = (() => {
  ...
  function _renderHomepageSetting() {
    ...
    const resolved = Clacky.ext.ui.resolveHomepage();
    select.value = resolved.type === "workspace" ? resolved.workspaceId : "native";
    select.onchange = () => Clacky.ext.ui.selectHomepage(select.value);
  }
