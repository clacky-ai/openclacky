  ...
  function _renderTaskRow(t) {
    ...
    row.innerHTML = `
      ...
      <div class="task-col task-col-actions">
        <button class="task-btn task-btn-run"  title="Run now"><i data-lucide="play" class="icon-sm"></i> Run</button>
        <button class="task-btn task-btn-edit" title="Edit task"><i data-lucide="pencil" class="icon-sm"></i> Edit</button>
        <button class="task-btn task-btn-del"  title="Delete"><i data-lucide="x" class="icon-sm"></i></button>
      </div>`;
    ...
    renderTable() {
      ...
      if (_tasks.length === 0) {
        ...
        empty.innerHTML = `
          ...
          <button class="task-create-btn" id="btn-create-task-empty"><i data-lucide="plus" class="icon-sm"></i> Create Task</button>`;
      ...
      // Reinitialize Lucide icons for dynamically created content
