  ...
  function _wireDetail() {
    ...
    if (installBtn) {
      installBtn.addEventListener("click", () => {
        ...
        // Show a "downloading" placeholder rather than a generic "installing" —
        // the next real state is always the download starting, so this avoids
        // a jarring "installing → downloading → installing" flash before any
        // real progress data has arrived.
