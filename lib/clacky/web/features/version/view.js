  ...
  function _renderConfirmState(pop, s) {
    pop.innerHTML = `
      ...
      <div class="vup-actions">
        ...
        ${(typeof Brand !== "undefined" && Brand.branded) ? "" : `<a id="vup-btn-changelog" class="vup-btn-changelog" href="https://github.com/clacky-ai/openclacky/releases" target="_blank" rel="noopener noreferrer">${I18n.t("upgrade.btn.changelog")}</a>`}
      </div>
    `;
