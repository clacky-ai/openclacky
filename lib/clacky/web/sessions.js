  ...
  return {
    ...
    init() {
      ...
      document.addEventListener("click", async (e) => {
        ...
        // Local deployments preview supported files and hand safe binary
        // formats to the OS. Remote deployments download the file.
        if (isLocal && window.Clacky && Clacky.WorkspaceView &&
            await Clacky.WorkspaceView.openLinkedFile(filePath)) return;
