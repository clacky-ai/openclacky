...
const FileAC = (() => {
  ...
  async function _showDropdown(query) {
    ...
    // Fetch files from server; skip rendering when a newer query has
    // superseded this one (out-of-order responses would show stale results).
    const seq = ++_fetchSeq;
