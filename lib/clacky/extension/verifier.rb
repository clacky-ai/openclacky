...
module Clacky
  ...
  module ExtensionVerifier
    ...
    KNOWN_TOP_KEYS    = %w[id name name_zh display_name display_name_zh title description description_zh emoji version origin author homepage license public license_required keywords enabled_by_default config contributes].freeze
