...
(function () {
  ...
  function createExtensionsPanel() {
    ...
    async function reload() {
      ...
      brandPublished = cloud.filter((e) => e.origin === "self");
    }
    ...
    function rebuild(headerActions) {
      ...
      container.appendChild(section("extlist.section.cloud", "extlist.section.cloudHint", marketCloud, cloudCard, "extlist.cloud.empty"));
      if (brandPublished.length > 0 || (typeof Brand !== "undefined" && Brand.userLicensed)) {
        container.appendChild(section("extlist.section.brand", "extlist.section.brandHint", brandPublished, cloudCard, "extlist.brand.empty"));
      }
